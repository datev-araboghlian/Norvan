  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        />
        <div
          className="absolute top-1/3 -left-32 w-[440px] max-w-[90vw] aspect-square rounded-full bg-blue-600/10 blur-[120px]"
      ...
      <div className="relative z-10 flex-1 mx-auto w-full max-w-7xl px-5 sm:px-8 flex flex-col justify-center pt-32 pb-28 sm:pb-32">
        <span
          className="hero-rise inline-flex w-fit items-center gap-2 px-4 py-2 rounded-full glass text-xs sm:text-sm text-norvan-100 mb-7"
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group inline-flex items-center justify-center gap-3 px-6 py-4 rounded-2xl glass font-semibold transition-colors hover:bg-white/10 w-full sm:w-auto"
          >
